...
public class hotel1 extends AppCompatActivity {
    ...
    private String hotelNombre; // Variable para almacenar el nombre del hotel
    ...
    private void cargarHabitaciones() {
        String url = "http://192.168.56.1:80/crud_hotelitos/hotel1.php";
        JsonObjectRequest requerimiento = new JsonObjectRequest(Request.Method.GET, url, null,
                response -> {
                    try {
                        JSONArray jsonArray = response.getJSONArray("habitacion");
                        ...
                        if (count == 0) {
                            TextView noHabitaciones = findViewById(R.id.no_habitaciones);
                            noHabitaciones.setVisibility(View.VISIBLE);
                        } else {
                            ...
                            TextView noHabitaciones = findViewById(R.id.no_habitaciones);
                            noHabitaciones.setVisibility(View.GONE);
                ...
                error -> Toast.makeText(hotel1.this, "Error de conexión: " + error.getMessage(), Toast.LENGTH_SHORT).show());
                ...
                response -> {
                    try {
                        ...
                        if (jsonResponse.has("success")) {
                            Toast.makeText(hotel1.this, "Elección guardada, vaya a la sección Reservas para completar el pago.", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(hotel1.this, "Error al actualizar el estado.", Toast.LENGTH_SHORT).show();
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                        Toast.makeText(hotel1.this, "Error al procesar la respuesta del servidor.", Toast.LENGTH_SHORT).show();
                    }
                },
                error -> {
                    Toast.makeText(hotel1.this, "Error al conectar con el servidor.", Toast.LENGTH_SHORT).show();
                }) {
            @Override
            ...
            public AdaptadorUsuarioHolder(@NonNull View itemView) {
                ...
                botonReserva.setOnClickListener(v -> {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        ...
                        Intent intent = new Intent(hotel1.this, hoteles.class);
