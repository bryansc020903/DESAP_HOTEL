...
public class hotel4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boton_imagen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(hotel4.this, "Regresar", Toast.LENGTH_SHORT).show();
    ...
    private void cargarHabitaciones() {
        String url = "http://192.168.56.1:80/crud_hotelitos/hotel4.php"; // Cambia a la URL de tu base de datos para hotel4
        JsonObjectRequest requerimiento = new JsonObjectRequest(Request.Method.GET,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONArray jsonArray = response.getJSONArray("habitacion"); // Asegúrate de que este sea el nombre correcto
                            ...
                            lst1.setLayoutManager(new LinearLayoutManager(hotel4.this));
                            lst1.setAdapter(adaptadorUsuario);
                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(hotel4.this, "Error al procesar los datos", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(hotel4.this, "Error de conexión: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void actualizarEstadoHabitacion(String numeroHabitacion) {
        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.56.1:80/crud_hotelitos/actualiza_estado.php",
                response -> {
                    // Mostrar mensaje si la actualización fue exitosa
                    try {
                        JSONObject jsonResponse = new JSONObject(response);
                        if (jsonResponse.has("success")) {
                            Toast.makeText(hotel4.this, "Elección guardada, vaya a la sección Reservas para completar el pago.", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(hotel4.this, "Error al actualizar el estado.", Toast.LENGTH_SHORT).show();
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                        Toast.makeText(hotel4.this, "Error al procesar la respuesta del servidor.", Toast.LENGTH_SHORT).show();
                    }
                },
                error -> {
                    Toast.makeText(hotel4.this, "Error al conectar con el servidor.", Toast.LENGTH_SHORT).show();
                }) {
            @Override
            ...
            public AdaptadorUsuarioHolder(@NonNull View itemView) {
                ...
                botonReserva.setOnClickListener(v -> {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        ...
                        Intent intent = new Intent(hotel4.this, hoteles.class);
