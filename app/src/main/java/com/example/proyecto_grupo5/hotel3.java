...
public class hotel3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boton_imagen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(hotel3.this, "Regresar", Toast.LENGTH_SHORT).show();
    ...
    private void cargarHabitaciones() {
        String url = "http://192.168.56.1:80/crud_hotelitos/hotel3.php";
        JsonObjectRequest requerimiento = new JsonObjectRequest(Request.Method.GET,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            lst1.setLayoutManager(new LinearLayoutManager(hotel3.this));
                            lst1.setAdapter(adaptadorUsuario);
                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(hotel3.this, "Error al procesar los datos", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(hotel3.this, "Error de conexión: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                response -> {
                    try {
                        ...
                        if (jsonResponse.has("success")) {
                            Toast.makeText(hotel3.this, "Elección guardada, vaya a la sección Reservas para completar el pago.", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(hotel3.this, "Error al actualizar el estado.", Toast.LENGTH_SHORT).show();
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                        Toast.makeText(hotel3.this, "Error al procesar la respuesta del servidor.", Toast.LENGTH_SHORT).show();
                    }
                },
                error -> {
                    Toast.makeText(hotel3.this, "Error al conectar con el servidor.", Toast.LENGTH_SHORT).show();
                }) {
            @Override
            ...
            public AdaptadorUsuarioHolder(@NonNull View itemView) {
                ...
                botonReserva.setOnClickListener(v -> {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        ...
                        Intent intent = new Intent(hotel3.this, hoteles.class);
